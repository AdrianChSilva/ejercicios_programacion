...
public class Ejercicio15_T06MelodiaUltimaNotaCoincPrimera  {

  public static void main(String[] args) {
    
    int notas = 4 *(int)(Math.random()*7 + 1); /**Ese '4 * ' me garantiza que los
    numeros (del 1 al 7) que salgan sean múltiplos de 4*/
    String nota = "";
    String primeraNota = "";
    int contadorNota;
