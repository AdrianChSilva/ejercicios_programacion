/**
 * El programa GestiMat (gestión de matrículas) necesita almacenar los datos sobre los alumnos que
 * se matriculan en un centro educativo. Crea la clase Alumno de tal forma que de cada uno de ellos
 * se sepa su nombre, sus apellidos y su dirección de correo electrónico. A cada alumno se le asigna
 * de forma automática un número de expediente empezando por el que se decida cada curso. El
